...
export default function ManufacturingOrderManagementLandingPage() {
  return (
    <MainLayout landingPage="/manufacturing-order-management">
      {/* Hero Section */}
            ...
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl/none">
                  The Manufacturing ERP with advanced Order Management Software.
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground lg:text-xl">
                Manage custom orders, BOMs, inventory, and production - all in one ERP + MRP solution. Streamline your manufacturing processes with advanced planning, real-time inventory, and production control tools.
                </p>
              </div>
              <ProductRating />
              <LeadEmailCapture landingPage="manufacturing-order-management" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl text-white">
              Cloud-based ERP + MRP with Order Management.
            </h2>
      ...
      <FeaturesSection landingPage="manufacturing-order-management" />
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button size="lg" className="bg-blue-primary text-white hover:bg-blue-secondary" asChild>
                <Link href="/signup?landingPage=manufacturing-order-management">
                  Start Now
                  <ChevronRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <Link href="/demo?landingPage=manufacturing-order-management">
                  Talk to an Expert
                </Link>
              </Button>
            </div>
