...
export const metadata = {
  title: 'Best Manufacturing Resource Planning Software',
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                ...
                Manufacturing Resource Planning Software (MRP) to run your manufacturing business.
                </h1>
              ...
              <ProductRating />
              <LeadEmailCapture landingPage="manufacturing-resource-planning-software" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
