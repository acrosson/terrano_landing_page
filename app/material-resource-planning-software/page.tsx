...
export const metadata = {
  title: 'Material Resource Planning Software for Manufacturers',
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                ...
                Material Resource Planning Software (MRP) to run your manufacturing business.
                </h1>
              ...
              <ProductRating />
              <LeadEmailCapture landingPage="material-resource-planning-software" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button size="lg" className="bg-blue-primary text-white hover:bg-blue-secondary" asChild>
                <Link href="/signup?landingPage=material-resource-planning-software">
                  Start Now
                  <ChevronRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <Link href="/demo?landingPage=material-resource-planning-software">
                  Talk to an Expert
                </Link>
              </Button>
            </div>
