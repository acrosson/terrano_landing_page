...
export const metadata = {
  title: 'Manufacturing Process Software',
...
export default function ManufacturingProcessSoftwareLandingPage() {
  return (
    <MainLayout landingPage="/manufacturing-process-software">
      {/* Hero Section */}
            ...
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl/none">
                  The #1 cloud-based Business Software for Manufacturing Processes.
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground lg:text-xl">
                  Streamline your manufacturing processes with advanced planning, real-time inventory, and production control tools.
                </p>
              </div>
              <ProductRating />
              <LeadEmailCapture landingPage="manufacturing-process-software" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
      ...
      <FeaturesSection landingPage="manufacturing-process-software" />
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button size="lg" className="bg-blue-primary text-white hover:bg-blue-secondary" asChild>
                <Link href="/signup?landingPage=manufacturing-process-software">
                  Start Now
                  <ChevronRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <Link href="/demo?landingPage=manufacturing-process-software">
                  Talk to an Expert
                </Link>
              </Button>
            </div>
