...
export const metadata = {
  title: 'Terrano - The Best Manufacturing ERP',
  description: 'The best cloud-based manufacturing ERP software. Automate production, materials, inventory, and scheduling—all in one platform.',
};

export default function BestManufacturingERPLandingPage() {
  return (
    <MainLayout landingPage="/best-manufacturing-erp">
      {/* Hero Section */}
            ...
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl/none">
                  The Best Cloud-Based Manufacturing ERP Software. All in one platform.
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground lg:text-xl">
                Automate production, materials, inventory, and scheduling - all in one platform. Run your manufacturing operations efficiently, without needing to compromise.
                </p>
              </div>
              <ProductRating />
              <LeadEmailCapture landingPage="best-manufacturing-erp" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl text-white">
              Cloud-based ERP + MRP Processing Software.
            </h2>
      ...
      <FeaturesSection landingPage="best-manufacturing-erp" />
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              <Button size="lg" className="bg-blue-primary text-white hover:bg-blue-secondary" asChild>
                <Link href="/signup?landingPage=best-manufacturing-erp">
                  Start Now
                  <ChevronRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" asChild>
                <Link href="/demo?landingPage=best-manufacturing-erp">
                  Talk to an Expert
                </Link>
              </Button>
            </div>
