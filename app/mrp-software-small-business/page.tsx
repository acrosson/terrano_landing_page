...
export default function MRPSmallBusinessLandingPage() {
  return (
    <MainLayout landingPage="/mrp-software-small-business">
      {/* Hero Section */}
            ...
            <div className="flex flex-col justify-center space-y-4 w-full">
              <div className="space-y-2 w-full">
                <h1 className="text-2xl font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl/none">
                  Best MRP Software for Small Businesses.
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground lg:text-xl">
                  Run your factory smarter with <b>AI-powered planning</b>, <b>real-time inventory</b>, and <b>production tools</b>. No steep learning curves.
                </p>
              </div>
              <ProductRating />
              <LeadEmailCapture landingPage="mrp-software-small-business" />
            </div>
            <HeroGraphicERP />
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter md:text-4xl text-white">
              Cloud-based MRP Software for Small Business? Yes please!
            </h2>
